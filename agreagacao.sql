...
INSERT INTO produtos (descricao, preco_venda, preco_custo, id_categoria) VALUES ('Grampo', '1.00', '0.30', 3);
INSERT INTO produtos (descricao, preco_venda, preco_custo, id_categoria) VALUES ('Nintendo Switch', '3000', '1500', 4);
...
-- group by
SELECT id_categoria, MAX(preco_venda) AS 'Maior R$ da Categoria' FROM produtos GROUP BY id_categoria;
